...
public class MatchRepositoryImpl implements MatchRepository {
    ...
    @Override
    public List<Match> findConflictMatches(Long mateUuid, LocalDateTime startTime, LocalDateTime endTime, LocalDate pickUpday, Long boardId) {
        return matchJPARepository.findConflictMatches(mateUuid,startTime,endTime,pickUpday,boardId);
    }
}
