...
public class MateTagRepositoryImpl implements MateTagRepository {
    ...
    @Override
    public Optional<Set<MateTag>> findAllByMate(Mate findMate) {
    ...
    @Override
    public Set<MateTag> saveAll(Set<MateTag> mateTags) {
        return new HashSet<>(mateTagJPARepository.saveAll(mateTags));
    }

    @Override
    public void deleteAll(Set<MateTag> findMateTag) {
